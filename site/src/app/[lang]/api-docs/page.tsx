...
export async function generateMetadata(props: {
  ...
  return {
    title: getDict(lang).meta.api,
    alternates: langAlternates(lang, "/api-docs"),
  };
}
  ...
  return (
    <section className="card p-6">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <code className="break-all font-mono text-sm font-medium">{path}</code>
      </div>
      ...
      {params && params.length > 0 && (
        <>
          <dl className="mt-4 grid gap-3 md:hidden">
          ...
          <div className="scroll-x mt-4 hidden md:block">
            <table className="w-full min-w-[520px] text-left text-sm">
            <thead>
              <tr className="border-b" style={{ color: "var(--ink-4)" }}>
                <th className="py-2 pr-4 text-xs font-medium uppercase tracking-wider">
                  {t.apiDocs.thParam}
                </th>
                <th className="py-2 pr-4 text-xs font-medium uppercase tracking-wider">
                  {t.apiDocs.thType}
                </th>
                <th className="py-2 text-xs font-medium uppercase tracking-wider">
                  {t.apiDocs.thMeaning}
                </th>
              </tr>
            </thead>
            <tbody>
              {params.map((p) => (
                <tr key={p.name} className="border-b last:border-0">
                  ...
                  <td
                    className="whitespace-nowrap py-2 pr-4 font-mono text-xs"
...
export default async function ApiDocs(props: {
  ...
  const classifierVersionDesc =
    lang === "fr"
      ? "Épingle une version précise. Sans ce paramètre, la version active est utilisée."
      : "Pins an exact version. Without this parameter, the active version is used.";
  const classifierParams: Param[] = [
    {
      name: "label_source",
      type: "direct | classifier",
      desc:
        lang === "fr"
          ? "Choisit les étiquettes directes ou les prédictions du classificateur. La valeur par défaut est direct."
          : "Selects direct labels or classifier predictions. The default is direct.",
    },
    {
      name: "label_mode",
      ...
      desc:
        lang === "fr"
          ? "Combine les prédictions des deux enseignants par union ou par intersection. Exige label_source=classifier."
          : "Combines the two teacher predictions by union or intersection. Requires label_source=classifier.",
    },
    {
      name: "classified",
      type: "1 | 0",
      desc:
        lang === "fr"
          ? "Inclut ou exclut les travaux couverts par la version du classificateur."
          : "Includes or excludes works covered by the classifier version.",
    },
    {
      name: "classifier_version",
      type: "string",
      desc: classifierVersionDesc,
    },
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      <Endpoint
        ...
        params={[
          ...
          },
          {
            name: "retracted",
            type: "1 | 0",
            desc: t.apiDocs.cohortParams.retracted,
          },
          {
            name: "abstract",
            type: "has | none",
            desc: t.apiDocs.cohortParams.abstract,
          },
          {
            name: "category",
          ...
          },
          {
            name: "agreement",
            type: "any | all",
            desc: t.apiDocs.cohortParams.agreement,
          },
          {
            name: "labeled",
            type: "1 | 0",
            desc: t.apiDocs.cohortParams.labeled,
          },
          ...classifierParams,
        ]}
        ...
        params={[
          {
            name: "format",
            type: "csv | json",
            desc: t.apiDocs.exportParams.format,
          },
        ]}
      ...
      <Endpoint
        ...
        params={[
          { name: "q", type: "string", desc: t.apiDocs.worksParams.q },
          {
            ...
            type: "int",
            desc: t.apiDocs.worksParams.year,
          },
          ...
          {
            name: "institution, funder, keyword",
            type: "string",
            desc: t.apiDocs.worksParams.memberships,
          },
          {
            name: "route",
            type: "aff | fund | venue | about | no_aff",
            desc: t.apiDocs.worksParams.route,
          },
          {
            name: "retracted",
            type: "1",
            desc: t.apiDocs.worksParams.retracted,
          },
          {
            name: "no_abstract",
            type: "1",
            desc: t.apiDocs.worksParams.noAbstract,
          },
          { name: "n_in", type: "0..3", desc: t.apiDocs.worksParams.nIn },
          ...classifierParams,
          {
            name: "sort",
            type: "cited | year_desc | year_asc",
            desc: t.apiDocs.worksParams.sort,
          },
          {
            name: "page, per_page",
            type: "int",
            desc: t.apiDocs.worksParams.page,
          },
        ]}
      ...
      <Endpoint
        ...
        params={[
          { name: "abstract", type: "1", desc: t.apiDocs.workAbstractParam },
          {
            name: "classifier_version",
            type: "string",
            desc: classifierVersionDesc,
      ...
      <Endpoint
        t={t}
        path="/api/v1/recent"
        desc={t.apiDocs.recentDesc}
        note={t.apiDocs.recentNote}
        params={[
          { name: "days", type: "15..30", desc: t.apiDocs.recentParams.days },
          { name: "q", type: "string", desc: t.apiDocs.recentParams.q },
          {
            name: "route",
            type: "ca_aff | ca_fund | ca_venue | about_ca",
            desc: t.apiDocs.recentParams.route,
          },
          {
            name: "year, type, lang, has_abstract",
            type: "int | string | string | bool",
            desc: t.apiDocs.recentParams.facets,
          },
          {
            name: "institution, funder, keyword, venue, topic, field",
            type: "string",
            desc: t.apiDocs.recentParams.exact,
          },
          {
            name: "page, per_page",
            type: "int",
            desc: t.apiDocs.recentParams.page,
          },
        ]}
        example={t.apiDocs.recentExample(BASE)}
      />

      <Endpoint
        t={t}
        path="/api/v1/recent/{id}"
        desc={t.apiDocs.recentWorkDesc}
        example={t.apiDocs.recentWorkExample(BASE)}
      />
        ...
        params={[
          {
            name: "contested_only",
            type: "1",
            desc: t.apiDocs.screenedParams.contestedOnly,
          },
          { name: "n_in", type: "0..3", desc: t.apiDocs.screenedParams.nIn },
          {
            name: "stratum",
            type: "string",
            desc: t.apiDocs.screenedParams.stratum,
          },
          {
            name: "page, per_page",
            type: "int",
            desc: t.apiDocs.screenedParams.page,
          },
        ]}
