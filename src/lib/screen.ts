 ...
 * rows (zero mismatches). Counting T3 as "in", which is the obvious reading of
 * "tier is not OUT", makes each model's count larger than the union of all three, which is
