 ...
 * over the machine-labeled subset. Same function the Landscape page renders,
...
export async function GET() {
  ...
  return json({
    meta: {
      ...
      note: 'Counts are over the labeled subset only. An unlabeled work is NOT a negative; the label table is sparse and grows as labeling rounds land.',
    },
    ...stats,
  })
}
